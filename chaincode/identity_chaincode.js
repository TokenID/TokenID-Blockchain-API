 ...
 * @constructor
 */
function IdentityChaincode(chain, chaincodeID) {
...
module.exports.IdentityChaincode = IdentityChaincode;
 ...
 */
IdentityChaincode.prototype.createCompany = function (enrollID, cb) {
 ...
 */
IdentityChaincode.prototype.getCompany = function(enrollID, company, cb) {
 ...
 */
IdentityChaincode.prototype.createPaper = function(enrollID, paper, cb) {
 ...
 * @param cb A callback of the form: function(error, result)
 */
IdentityChaincode.prototype.transferPaper = function(enrollID, paper, cb) {
 ...
 */
IdentityChaincode.prototype.getPapers = function(enrollID, cb) {
